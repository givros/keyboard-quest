  ...
  CQ.translations = {
    fr: {
      ...
      leaderboard: {
        ...
        syncLabel: "Room unique",
        syncHelp: "Tous les joueurs publient automatiquement ici. La page scores.html affiche ce tableau.",
        clearRoom: "Vider la room",
        clearing: "Vidage de la room...",
        live: "Room unique {room} active : scores synchronises en direct.",
        connecting: "Connexion a la room unique {room}...",
    ...
    en: {
      ...
      leaderboard: {
        ...
        updated: "Updated",
        empty: "No scores yet.",
        syncLabel: "Single room",
        syncHelp: "All players publish here automatically. scores.html shows this table.",
        clearRoom: "Clear room",
        clearing: "Clearing room...",
        live: "Single room {room} active: scores are syncing live.",
        connecting: "Connecting to single room {room}...",
        relayError: "Sync temporarily unavailable: regular checks are still running.",
        local: "Local mode: games remain available.",
    ...
    es: {
      ...
      leaderboard: {
        ...
        syncLabel: "Room unica",
        syncHelp: "Todos los jugadores publican aqui automaticamente. scores.html muestra esta tabla.",
        clearRoom: "Vaciar room",
        clearing: "Vaciando room...",
        live: "Room unica {room} activa: puntuaciones sincronizadas en directo.",
        connecting: "Conectando a la room unica {room}...",
        relayError: "Sincronizacion temporalmente no disponible: las verificaciones regulares siguen activas.",
        local: "Modo local: los juegos siguen disponibles.",
