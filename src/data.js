(function registerData(CQ) {
  ...
  addTypingLines("en", "5e", "defi", [
    ...
    "Precision mission: no mistake, five lines.",
  ...
  CQ.translations = {
    ...
    en: {
      ...
      leaderboard: {
        ...
        updated: "Updated",
        empty: "No scores yet.",
        syncLabel: "Supabase scores",
        syncHelp: "Each nickname is saved here, then points update the same row.",
        clearRoom: "Clear scores",
        clearing: "Clearing scores...",
        live: "Supabase active: scores are syncing live.",
        connecting: "Connecting to Supabase...",
        relayError: "Sync temporarily unavailable: regular checks are still running.",
        supabaseConnecting: "Connecting to Supabase...",
        supabaseError: "Supabase is temporarily unavailable: retrying in a few seconds.",
        supabaseMissingConfig: "Supabase is not configured yet: scores stay local.",
    ...
    es: {
      ...
      leaderboard: {
        ...
        connecting: "Conectando a Supabase...",
        relayError: "Sincronizacion temporalmente no disponible: las verificaciones regulares siguen activas.",
        supabaseConnecting: "Conectando a Supabase...",
        supabaseError: "Supabase no esta disponible temporalmente: nueva verificacion en unos segundos.",
        supabaseMissingConfig: "Supabase todavia no esta configurado: las puntuaciones siguen locales.",
