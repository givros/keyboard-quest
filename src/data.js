  ...
  CQ.translations = {
    fr: {
      ...
      landing: {
        ...
        roomLabel: "Code classe",
        roomPlaceholder: "Ex : 5e-a-vendredi",
        start: "Commencer",
      ...
      leaderboard: {
        ...
        local: "Mode local : aucun code classe actif.",
        never: "Jamais",
      },
      play: {
    ...
    en: {
      ...
      landing: {
        ...
        roomLabel: "Class code",
        roomPlaceholder: "Example: 5e-a-friday",
        start: "Start",
      ...
      leaderboard: {
        ...
        local: "Local mode: no class code is active.",
        never: "Never",
      },
      play: {
    ...
    es: {
      ...
      landing: {
        ...
        roomLabel: "Codigo de clase",
        roomPlaceholder: "Ej.: 5e-a-viernes",
        start: "Empezar",
      ...
      leaderboard: {
        ...
        local: "Modo local: no hay codigo de clase activo.",
        never: "Nunca",
      },
      play: {
